<x-guest-layout>
    <h1 class="text-lg font-semibold text-gray-800 mb-1 mt-6">Selamat Datang</h1>
    <p class="text-sm text-gray-500 mb-6">Masuk ke akun kamu untuk melanjutkan.</p>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-coral-500 shadow-sm focus:ring-coral-400" name="remember">
